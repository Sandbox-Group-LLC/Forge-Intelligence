...
export type ViewType = 'new-analysis' | 'active-run' | 'brand-profile' | 'strategy' | 'brain-history' | 'geo-strategist' | 'strategy-intel' | 'authenticity-enricher' | 'content-generator' | 'campaign-generator' | 'social-generator' | 'video-generator' | 'ads-generator' | 'email-campaign' | 'quick-copy' | 'compliance-gate' | 'integrations' | 'publishing-queue' | 'content-library' | 'content-import' | 'admin' | 'topic-queue' | 'performance' | 'brand-settings';
