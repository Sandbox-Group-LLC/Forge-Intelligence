...
export type ViewType = 'new-analysis' | 'active-run' | 'brand-profile' | 'strategy' | 'brain-history' | 'geo-strategist' | 'authenticity-enricher' | 'content-generator' | 'campaign-generator' | 'compliance-gate';
