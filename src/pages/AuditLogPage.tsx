...
export default function AuditLogPage() {
  ...
  const S: Record<string, React.CSSProperties> = {
    ...
    input: { padding: '7px 10px', border: '1px solid #E2E8F0', borderRadius: 'var(--radius-sm)', fontSize: 13, color: '#0F172A', background: '#fff' },
    btn: { padding: '8px 16px', borderRadius: 'var(--radius-sm)', border: '1px solid #3563FF', background: '#3563FF', color: '#fff', fontSize: 13, fontWeight: 600, cursor: 'pointer' },
    btnGhost: { padding: '8px 16px', borderRadius: 'var(--radius-sm)', border: '1px solid #E2E8F0', background: '#fff', color: '#0F172A', fontSize: 13, fontWeight: 600, cursor: 'pointer' },
