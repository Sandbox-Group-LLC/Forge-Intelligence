...
const CHANNELS: ChannelDef[] = [
  ...
  },
  {
    id: 'ghost',
    label: 'Ghost',
    description: 'Publish full articles to your Ghost site via a Pipedream workflow. Pipedream handles the Ghost auth — you just paste the workflow trigger URL.',
    color: '#15171A',
    logo: 'GH',
    liveStatus: 'live',
    credentialFields: [
      { key: 'pipedreamUrl', label: 'Pipedream Workflow URL', placeholder: 'https://eo*.m.pipedream.net/...' },
    ],
    setupGuide: {
      title: 'Pipedream → Ghost Workflow',
      steps: [
        { text: 'Open your Pipedream workspace and create a new HTTP-triggered workflow.', url: 'https://pipedream.com/' },
        { text: 'Copy the unique HTTP trigger URL Pipedream gives you (looks like https://eo*.m.pipedream.net/...).' },
        { text: 'Paste the trigger URL above.' },
        { text: 'In the Pipedream workflow, add a step that calls Ghost\'s Admin API with the body fields Forge sends: title, html, canonicalUrl, metaTitle, metaDescription, featureImageUrl, status. Pipedream\'s Ghost integration handles the JWT auth for you.' },
        { text: 'Have the workflow respond with JSON: { success: true, url: "<published-post-url>", postId: "<ghost-post-id>" }. Forge stores both for analytics + delete operations.' },
      ],
    },
  },
];
