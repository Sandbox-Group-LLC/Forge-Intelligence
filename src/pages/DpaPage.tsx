...
const styles: Record<string, React.CSSProperties> = {
  ...
  banner: { background: 'rgba(53,99,255,0.1)', border: '1px solid rgba(53,99,255,0.25)', borderRadius: 'var(--radius-sm)', padding: '14px 18px', fontSize: 13, color: '#CBD5E1', lineHeight: 1.65, marginBottom: 24 },
