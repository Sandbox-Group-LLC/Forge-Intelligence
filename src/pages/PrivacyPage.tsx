    ...
    <div style={styles.root}>
      <div style={styles.container}>
        ...
        <div style={styles.header}>
          ...
          <p style={styles.subtitle}>Effective: June 12, 2026 &nbsp;·&nbsp; Forge Intelligence LLC &nbsp;·&nbsp; Portland, OR</p>
        </div>
        ...
        <div style={styles.card}>
          ...
          <Section title="2. What We Collect and Why">
            ...
            <P><strong style={styles.strong}>Brand and business data.</strong> You provide a domain URL to seed the platform. We use that URL to crawl publicly available signals — brand voice, tone, competitive positioning, and content patterns — and store the resulting intelligence in your isolated brand profile. Crawling of your site, and of your competitors' publicly available websites, is performed via Jina Reader and Bright Data (see Section 6). During brand analysis and market research, we also send your brand URL, competitor URLs, and market-context queries to Perplexity AI for web-sourced intelligence gathering. Everything generated from your brand belongs to you.</P>
            <P><strong style={styles.strong}>AI visibility measurement data.</strong> To measure whether AI search engines cite your brand, we generate category-level buyer questions (which describe your market, never a person, and deliberately exclude your brand name) and submit them to AI engines — Perplexity, OpenAI, Google Gemini, and Google AI Overviews via a SERP provider. The engines' answers and cited sources are stored in your workspace as citation-tracking results. No personal data is included in these queries.</P>
          ...
          <Section title="4. How We Use Your Data">
            <UL items={[
              ...
              "To perform market research and competitive intelligence using Perplexity AI. Your brand URL, competitor URLs, and market-context queries are sent to Perplexity's API during brand analysis and topic discovery stages. We also crawl your competitors' publicly available websites (via Jina Reader and Bright Data) to ground competitive-gap analysis in what they actually publish.",
              "To measure your brand's AI search visibility. Category-level buyer questions — generated from your market context, never containing personal data or your brand name — are submitted to Perplexity, OpenAI, Google Gemini, and Google AI Overviews (via a SERP data provider) to check whether and where AI engines cite your brand. This runs during GEO topic discovery, on the Performance Dashboard's citation tracker, and on the public AI Visibility Scan.",
